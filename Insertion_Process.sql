...
values ('I1', 'Fatma Tolba'),
	   ('I2', 'Ali Elmasry'),
	   ('I3', 'Ahmed ezz'  );


------------Insert into Courses---------------------
Insert into Courses (crs_id, crs_name, inst_id)
values ('C1', 'DotNet' , 'I1'),
	   ('C2', 'Mobile' , 'I2'),
	   ('C3', 'English', 'I3');
...
values(1,'Our vicar is always …………… money for for one cause or another.','T9'),
	  (2,'The experts were not fully …………… that the animal was puma.','T9'),
	  -------Grammar-------
	  (3,'It was not until the thirteenth stroke …………… the bell stopped.','T10'),
	  (4,'They were amazed to find that the goddess …………… to be a very modern-looking woman.','T10'),
	  -----Vocabulary------
	  (5,'Editors of newspapers and magazines often go to extremes to provide their ………….. withunimportant facts and statistics.','T9'),
	  (6,'He feels that his rise in …………. is well worth the loss of money.','T9'),
	  (7,'The dogs are allowed to …………….. outside the enclosure.','T9'),
	  (8,'After …………. at the display for several minutes, Mr. Taylor went back into his shop.','T9'),
	  (9,'The silence was suddenly …………. when a large car roared down the decade.','T9'),
	  -------Grammar-------
	  (10,'Theatrical …………….. and artificial blood had been used to make the injuries look realistic.','T10'),
	  (11,'You will feel better after you …………. a rest.','T10'),
	  (12,'When you …………….. next year, the children ………… much taller.','T10'),
	  (13,'Active: I never hear him shout at his children. Passive: ………………….','T10'),
	  (14,'Had I known she was sick, I ………… her.','T10'),
	  (15,'It is imperative that he ……………. The school regulations.','T10'),
	  (16,'I wish that I ………….. in Hanoi at the end of 1972 to witness the “Battle of Dien Bien Phu inthe Air”.','T10'),
	  (17,'The decision was postponed, ………….. was exactly what he wanted.','T10'),
	  (18,'Never ……………. her stand on the deserted station platform.','T10'),
	  (19,'Please ……………… my luggage ……………. To the airport tomorrow morning.','T10'),
	  -------Vocabulary-------
	  (20,'There must be a large number of stars with planets which could ……………. Intelligent beings in the universe.','T9'),
	  -----SQL-----
	  (21, 'What is SQL Server?', 'T1'),
	  (22, 'When was the first version of Microsoft SQL Server released?', 'T1'),
	  (23, 'Which of the following is a free database software running free SQL Server technology?', 'T1'),
	  -----C#------
	  (24, 'What is the output of (int x = 10; int y = 20; int z = x++ + ++y; Console.WriteLine(z);)', 'T2'),
	  (25, 'Which of the following statements about readonly fields in C# is true?', 'T2'),
	  (26, 'What is the purpose of the using statement in C#?', 'T2'),
	  -----OOP-----
	  (27, 'What does the term “encapsulation” refer to in OOP?', 'T3'),
	  (28, 'Which OOP concept allows a class to inherit properties and behaviors from another class?', 'T3'),
	  (29, 'What is the purpose of an interface in OOP?', 'T3'),
	  -----Asp.net-----
	  (30, 'What is the purpose of the ViewState in ASP.NET Web Forms?', 'T4'),
	  (31, 'Which of the following is an ASP.NET component that handles user input and generates HTML output?', 'T4'),
	  (32, 'In ASP.NET, which event occurs after the page has been fully rendered and sent to the client browser?', 'T4'),
	  -----WEB API-----
	  (33, 'What is the primary purpose of ASP.NET Web API?', 'T5'),
	  (34, 'Which HTTP methods are commonly used in ASP.NET Web API for CRUD operations?', 'T5'),
	  (35, 'In ASP.NET Web API, what does the ApiController class provide?', 'T5')
